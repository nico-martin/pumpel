...
export async function createTrainingTemplate(input: TrainingTemplateInput): Promise<TrainingTemplate> {
...
export async function getTrainingTemplate(id: string): Promise<TrainingTemplate | undefined> {
  const db = await getDB();
